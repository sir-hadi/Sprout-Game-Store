...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        <?php if ($this->session->has_userdata('email')) : ?>
            <div class="container">
                <a class="navbar-brand" href="<?= base_url('developer') ?>">Sprout Game Store</a>
                ...
                <div class="" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link btn btn-outline-light mr-3" href="<?= base_url('developer/formGameRequest') ?>">Request Publish Game</a>
                        </li>
                    </ul>
                </div>
                <div class="" id="navbarResponsive">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li>
                                <p style="font-weight: bolder;" class="dropdown-item">DEVELOPER</p>
                            </li>
                            <li>
                            ...
                            <li><a class="dropdown-item" href="<?= base_url('developer/myPublishedGames') ?>">My Revenue & Games </a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
